            ...
            <div className="py-12">
                    ...
                    <div className="w-full md:w-auto">
                        ...
                        <div className="relative max-w-md w-full">
                            ...
                            <Input
                                ...
                                className={
                                    isDark
                                        ? 'blog-input pl-10 rounded-full'
                                        : 'pl-10 rounded-full bg-muted/50 border-border'
                                }
                                value={search}
                                onChange={(e) => {
                ...
                {currentBlogs.length > 0 ? (
                    <div className="space-y-12 animate-fade-up delay-100">
                        ...
                        {featuredBlog && (
                            <BlogCard blog={featuredBlog} variant="featured" blogSurface={isDark} />
                        )}

                        {gridBlogs.length > 0 && (
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {gridBlogs.map((blog) => (
                                    <BlogCard key={blog.id} blog={blog} blogSurface={isDark} />
                                ))}
                            </div>
                        )}
